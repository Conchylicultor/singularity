      ...
      - Plugins:
        - **`paste-images`** — Image paste/drop support for the text editor. Uploads images via the attachments primitive and renders inline thumbnails with lightbox expand.
          - Web:
            ...
            - Uses: `infra/attachments.uploadAttachment`, `primitives/css/viewport-overlay.ViewportOverlay`, `primitives/text-editor.registerNodeExtension`, `primitives/text-editor.TextEditorSlots`
