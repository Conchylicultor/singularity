              ...
              - Plugins:
                ...
                - **`queued-command`** — Renders queued_command attachment events — a prompt the user queued while the agent was busy, awaiting delivery on the next turn.
                  - Web:
                    ...
                    - Uses: `conversations/conversation-view/jsonl-viewer/attachment.JsonlViewerAttachment`, `conversations/conversation-view/jsonl-viewer/collapsible-card.CollapsibleCard`, `primitives/text.Text`, `primitives/ui-kit.cn`
