...
- **`page`** [52 sub-plugins] — Block-based page editor.
...
- **`reports`** [11 sub-plugins] — Reports uncaught browser errors to the server. Records server/frontend crashes as deduped reports; investigation tasks are filed on demand.
