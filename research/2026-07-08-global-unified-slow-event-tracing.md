...
- **Wait placement is approximate** — waits are stored as union totals, not intervals; the leading-segment rendering is labeled as such in the UI. Fixing it means recording wait intervals (recorder change) — out of scope.
