...
| **ST5** | **Consumer migration + default fallback verification.** Confirm 4 call sites unchanged; generate `views` origins; author a committed reference instance set for `sonata/library` (only multi-view consumer). | ST4 | Core |
