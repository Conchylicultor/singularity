...
ALTER TABLE "tasks" ADD COLUMN "author" text;--> statement-breakpoint
UPDATE "tasks" SET "author" = 'user' WHERE "author" IS NULL;--> statement-breakpoint
UPDATE "conversations" SET "spawned_by" = 'singularity' WHERE "spawned_by" IS NULL;--> statement-breakpoint
