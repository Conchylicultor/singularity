...
ALTER TABLE "tasks" ADD COLUMN "held_at" timestamp with time zone;--> statement-breakpoint
CREATE VIEW "public"."tasks_v" AS (with "task_facts" as (select "id", EXISTS (
        ...
        ) as "min_completed_push_at" from "tasks") select "tasks"."id", "tasks"."parent_id", "tasks"."title", "tasks"."description", "tasks"."dropped_at", "tasks"."held_at", "tasks"."expanded", "tasks"."created_at", "tasks"."updated_at", 
        CASE
