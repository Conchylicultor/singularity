...
- Before writing or editing anything under `prototypes/`, read [`prototypes/CLAUDE.md`](prototypes/CLAUDE.md) — a prototype is one self-contained folder, and you design from the blank `_template/`: **never open another prototype's folder**, for any reason.
