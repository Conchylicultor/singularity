...
export const QueryConversationsBodySchema = z.object({
  ...
  // handler decodes it strictly against CONVERSATION_FILTERABLE (+ custom columns).
...
export type QueryConversationsBody = z.infer<
  typeof QueryConversationsBodySchema
>;
