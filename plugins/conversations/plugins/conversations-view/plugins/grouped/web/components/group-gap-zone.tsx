...
export function GroupGapZone({
  ...
  return (
    ...
    <div ref={setNodeRef} className={cn("relative z-raised h-4 -my-2")}>
      {isOver && (
        // eslint-disable-next-line layout/no-adhoc-layout -- horizontally inset-stretched, vertically centered drop indicator line; no Pin anchor combines x-inset-stretch with y-center
