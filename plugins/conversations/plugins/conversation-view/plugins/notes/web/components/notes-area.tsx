  ...
  return (
    <div className="relative">
      <textarea
        ...
        placeholder="Notes…"
        rows={2}
        className="w-full resize-y rounded-md border border-warning/60 bg-warning/10 px-3 py-2 text-caption placeholder:text-warning/70 focus:outline-none focus:ring-1 focus:ring-warning"
