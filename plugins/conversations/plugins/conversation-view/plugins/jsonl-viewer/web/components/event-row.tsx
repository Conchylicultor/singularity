...
function HoverActions({ event }: { event: JsonlEvent }) {
  ...
  return (
    <div className="absolute right-1 top-1 z-raised flex items-center gap-1 rounded-lg px-1.5 py-0.5 opacity-0 shadow-sm backdrop-blur-2xl transition-opacity group-hover/row:opacity-100 focus-within:opacity-100">
