...
2. End your FINAL message with one of these tokens on its own line, as the very last line — nothing may follow it:
   ...
   - \`FLAG_RAISE\` — something needs my attention (caveats, partial outcomes, follow-ups, skipped work, or the push didn't land). Above the token, list what I should know as short bullets.`;

export const CLEAN_TOKEN = "EXIT_CLEAN";
export const FLAG_TOKEN = "FLAG_RAISE";
