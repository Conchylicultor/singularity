...
The plugin runtime itself — not where features go.

- **Never change anything under `plugins/framework/` without the user's approval in this conversation.**
- New shared code is a plugin (`plugins/infra/plugins/<name>/`), not a framework change.
