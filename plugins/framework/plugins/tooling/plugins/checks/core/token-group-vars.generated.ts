...
export const TOKEN_GROUP_VARS: Record<string, readonly string[]> = {
  ...
  "typography": ["--font-mono", "--font-sans", "--font-serif", "--font-size-2xs", "--font-size-3xs", "--font-size-body", "--font-size-caption", "--font-size-heading", "--font-size-label", "--font-size-subheading", "--font-size-title", "--font-weight-bold", "--font-weight-medium", "--font-weight-normal", "--font-weight-semibold", "--letter-spacing", "--line-height-2xs", "--line-height-3xs", "--line-height-body", "--line-height-caption", "--line-height-heading", "--line-height-label", "--line-height-subheading", "--line-height-title"],
};
