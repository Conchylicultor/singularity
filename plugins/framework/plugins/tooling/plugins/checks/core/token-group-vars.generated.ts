...
export const TOKEN_GROUP_VARS: Record<string, readonly string[]> = {
  ...
  "type-scale": ["--font-size-2xs", "--font-size-3xs", "--font-size-body", "--font-size-caption", "--font-size-control", "--font-size-display", "--font-size-heading", "--font-size-label", "--font-size-subheading", "--font-size-title", "--font-weight-bold", "--font-weight-control", "--font-weight-medium", "--font-weight-normal", "--font-weight-semibold", "--line-height-2xs", "--line-height-3xs", "--line-height-body", "--line-height-caption", "--line-height-control", "--line-height-display", "--line-height-heading", "--line-height-label", "--line-height-subheading", "--line-height-title"],
};
