...
export const lintEntries: CollectedEntry[] = [
  ...
  { pluginPath: "primitives/plugins/truncating-text", id: "primitives.truncating-text", loader: () => import("@plugins/primitives/plugins/truncating-text/lint"), dependsOn: [] },
  { pluginPath: "primitives/plugins/viewport-overlay", id: "primitives.viewport-overlay", loader: () => import("@plugins/primitives/plugins/viewport-overlay/lint"), dependsOn: [] },
