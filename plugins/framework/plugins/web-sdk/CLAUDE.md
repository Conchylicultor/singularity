...
- Cross-plugin:
  - Slot contributors: `apps`, `command-palette`, `endpoint-errors`, `floating-bar`, `google-fonts`, `health`, `model-provider`, `mutation-errors`, `reports`, `shortcuts`, `slow-ops`, `theme-engine`, `toaster`
- Core:
