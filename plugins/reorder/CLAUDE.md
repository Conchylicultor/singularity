...
=======
    ...
    - `ConfigV2.Register` "welcome.actions"
    - `ConfigV2.Register` "actions"
    - `ConfigV2.Register` "nav-controls"
    - `ConfigV2.Register` "omnibox"
    - `ConfigV2.Register` "start-page"
    - `ConfigV2.Register` "sub-bar"
    - `ConfigV2.Register` "tab-strip"
    - `ConfigV2.Register` "viewport"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "toolbar"
    - `ConfigV2.Register` "deploy-deployment-detail.actions"
    - `ConfigV2.Register` "fields"
    - `ConfigV2.Register` "item-actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "deploy-server-detail.actions"
    - `ConfigV2.Register` "deploy-servers.actions"
    - `ConfigV2.Register` "fields"
    - `ConfigV2.Register` "item-actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "event-list.actions"
    - `ConfigV2.Register` "fields"
    - `ConfigV2.Register` "events-root.actions"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "event-source-detail.actions"
    - `ConfigV2.Register` "event-sources.actions"
    - `ConfigV2.Register` "item-actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "event-source-run.actions"
    - `ConfigV2.Register` "item-actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "toolbar"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "mail-thread.actions"
    - `ConfigV2.Register` "mail-message.actions"
    - `ConfigV2.Register` "mail-search.actions"
    - `ConfigV2.Register` "banner"
    - `ConfigV2.Register` "mail-root.actions"
    - `ConfigV2.Register` "rail-badge"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "mail-threads.actions"
    - `ConfigV2.Register` "fields"
    - `ConfigV2.Register` "header-actions"
    - `ConfigV2.Register` "overlay"
    - `ConfigV2.Register` "page-detail.actions"
    - `ConfigV2.Register` "pages-tree.actions"
    - `ConfigV2.Register` "row-actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "pages-root.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "prototypes-detail.actions"
    - `ConfigV2.Register` "prototypes-gallery.actions"
    - `ConfigV2.Register` "settings-config-index.actions"
    - `ConfigV2.Register` "rail-badge"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "fields"
    - `ConfigV2.Register` "sonata-library.actions"
    - `ConfigV2.Register` "sonata-player.actions"
    - `ConfigV2.Register` "song-actions"
    - `ConfigV2.Register` "end"
    - `ConfigV2.Register` "home"
    - `ConfigV2.Register` "hud"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "start"
    - `ConfigV2.Register` "transport"
    - `ConfigV2.Register` "end"
    - `ConfigV2.Register` "start"
    - `ConfigV2.Register` "story-detail.actions"
    - `ConfigV2.Register` "story-gallery.actions"
    - `ConfigV2.Register` "composition-compare.actions"
    - `ConfigV2.Register` "composition-detail.actions"
    - `ConfigV2.Register` "compositions.actions"
    - `ConfigV2.Register` "item-actions"
    - `ConfigV2.Register` "release-detail.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "contributions.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "table-detail.actions"
    - `ConfigV2.Register` "explorer.actions"
    - `ConfigV2.Register` "tree-row-accent"
    - `ConfigV2.Register` "tree-row-badge"
    - `ConfigV2.Register` "graph.actions"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "toolbar"
    - `ConfigV2.Register` "website-downloads.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "website-agents.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "website-apps.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "website-platform.actions"
    - `ConfigV2.Register` "end"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "start"
    - `ConfigV2.Register` "website-landing.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "workflows-definition-detail.actions"
    - `ConfigV2.Register` "workflows-definitions.actions"
    - `ConfigV2.Register` "workflows-execution-detail.actions"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "toolbar"
    ...
    - `ConfigV2.Register` "build.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "commit-detail.actions"
    - `ConfigV2.Register` "conv-file-tree.actions"
    - `ConfigV2.Register` "global-file-tree.actions"
    - `ConfigV2.Register` "config-v2-detail.actions"
    - `ConfigV2.Register` "config-v2-nav.actions"
    - `ConfigV2.Register` "agent-actions"
    - `ConfigV2.Register` "agent-detail.actions"
    - `ConfigV2.Register` "agent-side.actions"
    - `ConfigV2.Register` "agent-system-detail.actions"
    - `ConfigV2.Register` "agents-root.actions"
    - `ConfigV2.Register` "list"
    - `ConfigV2.Register` "list-actions"
    - `ConfigV2.Register` "system-agent"
    - `ConfigV2.Register` "view"
    - `ConfigV2.Register` "all-conversations.actions"
    - `ConfigV2.Register` "chips"
    - `ConfigV2.Register` "above-prompt-input"
    - `ConfigV2.Register` "action-bar"
    - `ConfigV2.Register` "conv-docs.actions"
    - `ConfigV2.Register` "file-peek.actions"
    - `ConfigV2.Register` "conv-commits-graph.actions"
    - `ConfigV2.Register` "conversation.actions"
    - `ConfigV2.Register` "item"
    - `ConfigV2.Register` "header"
    - `ConfigV2.Register` "overlay"
    - `ConfigV2.Register` "pending-prompt-action"
    - `ConfigV2.Register` "item"
    - `ConfigV2.Register` "agent-report.actions"
    - `ConfigV2.Register` "workflow-node.actions"
    - `ConfigV2.Register` "item"
    - `ConfigV2.Register` "prompt-bar"
    - `ConfigV2.Register` "prompt-input"
    - `ConfigV2.Register` "conv-push-profiling.actions"
    - `ConfigV2.Register` "conv-terminal.actions"
    - `ConfigV2.Register` "history-actions"
    - `ConfigV2.Register` "queue-actions"
    - `ConfigV2.Register` "sources"
    - `ConfigV2.Register` "conversations-recover.actions"
    - `ConfigV2.Register` "conv-summary.actions"
    - `ConfigV2.Register` "debug-boot-profile-detail.actions"
    - `ConfigV2.Register` "debug-boot-profile.actions"
    - `ConfigV2.Register` "debug-boot-profiles-list.actions"
    - `ConfigV2.Register` "debug-broadcasts.actions"
    - `ConfigV2.Register` "claude-cli-calls.actions"
    - `ConfigV2.Register` "config-orphans.actions"
    - `ConfigV2.Register` "debug-health-monitor.actions"
    - `ConfigV2.Register` "debug-heap-snapshot.actions"
    - `ConfigV2.Register` "debug-live-state-emit.actions"
    - `ConfigV2.Register` "live-state-health.actions"
    - `ConfigV2.Register` "logs-channel.actions"
    - `ConfigV2.Register` "logs.actions"
    - `ConfigV2.Register` "debug-memory.actions"
    - `ConfigV2.Register` "debug-profiling-build-detail.actions"
    - `ConfigV2.Register` "debug-profiling.actions"
    - `ConfigV2.Register` "debug-profiling-op-detail.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "queue.actions"
    - `ConfigV2.Register` "debug-read-set.actions"
    - `ConfigV2.Register` "render-profiler.actions"
    - `ConfigV2.Register` "report-detail.actions"
    - `ConfigV2.Register` "reports.actions"
    - `ConfigV2.Register` "trace-detail.actions"
    - `ConfigV2.Register` "traces.actions"
    - `ConfigV2.Register` "worktree-cleanup.actions"
    - `ConfigV2.Register` "zero-test.actions"
    - `ConfigV2.Register` "events-test.actions"
    - `ConfigV2.Register` "block"
    - `ConfigV2.Register` "format-action"
    - `ConfigV2.Register` "turn-into"
    - `ConfigV2.Register` "plugin-view.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "layout-lab.actions"
    - `ConfigV2.Register` "field-extension"
    - `ConfigV2.Register` "row-order"
    - `ConfigV2.Register` "floating-action"
    - `ConfigV2.Register` "plugin"
    - `ConfigV2.Register` "conv-review.actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "screenshot.actions"
    - `ConfigV2.Register` "item"
    - `ConfigV2.Register` "sidebar"
    - `ConfigV2.Register` "toolbar"
    - `ConfigV2.Register` "chart"
    - `ConfigV2.Register` "stats.actions"
    - `ConfigV2.Register` "attempt.actions"
    - `ConfigV2.Register` "option"
    - `ConfigV2.Register` "actions"
    - `ConfigV2.Register` "sources"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "task-detail.actions"
    - `ConfigV2.Register` "tasks-root.actions"
    - `ConfigV2.Register` "action"
    - `ConfigV2.Register` "fields"
    - `ConfigV2.Register` "list-actions"
    - `ConfigV2.Register` "task-actions"
    - `ConfigV2.Register` "section"
    - `ConfigV2.Register` "section"
