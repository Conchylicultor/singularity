  ...
  return (
    <div className="flex flex-col gap-1.5 py-3">
      ...
      <textarea
        ...
        className="w-full resize-y rounded-lg border border-input bg-transparent px-2.5 py-1.5 text-sm leading-relaxed placeholder:text-muted-foreground focus-visible:border-ring focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-input/30"
      />
    </div>
  );
};
