...
export default {
  ...
  ignores: {
    "no-adhoc-layout": [
      ...
      "plugins/apps/plugins/deploy/plugins/servers/web/components/server-create-form.tsx",
      "plugins/apps/plugins/deploy/plugins/servers/web/components/server-edit-form.tsx",
      ...
      "plugins/code-explorer/plugins/commit-detail/web/components/commit-diff-view.tsx",
