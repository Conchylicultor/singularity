...
/**
 * `Button`'s own text rungs: the control role (`text-control`, the type-scale's
 * `--font-size-control`) and its compact rung, driven by the shared step. The
 * weight rides separately on the cva's `font-control`, so a caller that swaps
 * this size for another role keeps the control's weight.
 */
