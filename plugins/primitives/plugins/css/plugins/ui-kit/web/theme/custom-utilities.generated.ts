...
export const CUSTOM_UTILITY_REGISTRY = [
  ...
  { classes: ["text-title", "text-heading", "text-subheading", "text-body", "text-label", "text-caption", "text-code", "text-title-compact", "text-heading-compact", "text-subheading-compact", "text-body-compact", "text-label-compact", "text-caption-compact", "text-code-compact"], extend: "font-size" },
