...
export const CUSTOM_UTILITY_REGISTRY = [
  ...
  { classes: ["px-pane-gutter"], extend: "px" },
  { classes: ["pane-gutter-flush"], standalone: true, reason: "pane-gutter override to 0 for a host that already supplies its own inset" },
