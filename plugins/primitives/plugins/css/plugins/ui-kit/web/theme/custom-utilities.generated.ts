...
export const CUSTOM_UTILITY_REGISTRY = [
  ...
  { classes: ["rail-none", "rail-2xs", "rail-xs", "rail-sm", "rail-md", "rail-lg", "rail-xl", "rail-2xl"], group: "sg-rail", conflictsWith: ["p", "px", "py"] },
  { classes: ["rail-x-none", "rail-x-2xs", "rail-x-xs", "rail-x-sm", "rail-x-md", "rail-x-lg", "rail-x-xl", "rail-x-2xl", "rail-owe-none", "rail-owe-2xs", "rail-owe-xs", "rail-owe-sm", "rail-owe-md", "rail-owe-lg", "rail-owe-xl", "rail-owe-2xl"], group: "sg-rail-x", conflictsWith: ["p", "px"] },
  { classes: ["rail-y-none", "rail-y-2xs", "rail-y-xs", "rail-y-sm", "rail-y-md", "rail-y-lg", "rail-y-xl", "rail-y-2xl"], group: "sg-rail-y", conflictsWith: ["p", "py"] },
