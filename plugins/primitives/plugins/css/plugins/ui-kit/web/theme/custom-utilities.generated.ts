...
export const CUSTOM_UTILITY_REGISTRY = [
  ...
  { classes: ["p-chip", "p-row", "p-card"], group: "sg-pad", excludes: ["p"], under: [] },
  ...
  { classes: ["text-display", "text-title", "text-heading", "text-subheading", "text-body", "text-label", "text-caption", "text-code", "text-display-compact", "text-title-compact", "text-heading-compact", "text-subheading-compact", "text-body-compact", "text-label-compact", "text-caption-compact", "text-code-compact"], extend: "font-size" },
