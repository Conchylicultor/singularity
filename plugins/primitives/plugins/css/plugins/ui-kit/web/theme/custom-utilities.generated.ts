...
export const CUSTOM_UTILITY_REGISTRY = [
  ...
  { classes: ["text-code", "text-display-compact", "text-title-compact", "text-heading-compact", "text-subheading-compact", "text-body-compact", "text-label-compact", "text-caption-compact", "text-control-compact", "text-code-compact"], extend: "font-size" },
