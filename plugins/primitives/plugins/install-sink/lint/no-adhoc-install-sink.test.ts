...
const WEB = "plugins/primitives/plugins/install-sink/web/internal/store.ts";
...
ruleTester.run(
  ...
  rule as unknown as Parameters<RuleTester["run"]>[1],
  {
    valid: [
      ...
      {
        filename:
          "plugins/primitives/plugins/install-sink/server/internal/resource.ts",
        code: `
      ...
      {
        filename: "plugins/primitives/plugins/install-sink/core/registry.ts",
        code: `
        let hooks = null;
