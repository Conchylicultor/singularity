...
context — reach for `<Text variant>` instead. The rule enforces repo-wide with
...
=======
  - Imported by: `apps/story/render`, `apps/story/shell`, `conversations/conversation-view/jsonl-viewer/assistant-text`, `debug/live-state-health`, `primitives/markdown`
>>>>>>> .merge_file_FLZKkU
- Web:
