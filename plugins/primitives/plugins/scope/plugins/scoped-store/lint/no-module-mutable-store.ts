 ...
 * (`primitives/scope/install-sink`). Reach for that before the escape hatch below: it
  ...
  meta: {
    ...
    messages: {
      moduleMutableStore:
        ...
        "(@plugins/primitives/plugins/scope/plugins/scoped-store/web) so state is per-surface. " +
