...
const makeHandle = () => defineScopedStore<State>({ count: 0, other: 0 });
...
describe("defineScopedStore", () => {
  it("two separate <Provider> mounts hold independent state", () => {
    ...
    function Reader({
      ...
      apiRef: { current: ReturnType<typeof Handle.useStoreApi> | null };
    }) {
    ...
    const aRef = {
      current: null as ReturnType<typeof Handle.useStoreApi> | null,
    };
    const bRef = {
      current: null as ReturnType<typeof Handle.useStoreApi> | null,
    };
