...
export function LinkChip({
  ...
  return (
    <button
      ...
      title={title}
      className={cn(
        "inline-flex max-w-full items-center gap-1.5 rounded-md bg-muted p-chip align-baseline text-caption text-primary hover:bg-muted/80 hover:underline [&_svg:not([class*='size-'])]:icon-auto",
        className,
      )}
    >
      {leading}
