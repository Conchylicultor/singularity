  ...
  meta: {
    ...
    messages: {
      adhocRaised:
        ...
        "(or `<Card>`) from `@plugins/primitives/plugins/surface/web`, which freezes the raised bundle " +
      ...
      adhocOverlay:
        ...
        "`@plugins/primitives/plugins/surface/web` (or `PopoverContent`/`DropdownMenuContent`), which " +
