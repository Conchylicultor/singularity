...
- Cross-plugin:
  - Imported by: `debug/op-rate`, `debug/sentinel`, `debug/slow-ops`, `debug/stall-monitor`, `debug/trace/contention`, `debug/trace/gates`, `debug/trace/pane`, `debug/trace/spans`, `debug/trace/stall`
