...
- Cross-plugin:
  - Imported by: `apps/browser/bookmarks`, `apps/mail/mail-core`, `apps/sonata/library`, `apps/sonata/track-mixer`, `apps/story/generation`, `config_v2/staging`, `conversations/session-chain`, `conversations/summary`, `debug/boot-profile`, `debug/slow-ops`, `debug/trace/engine`, `infra/claude-cli`, `infra/events`, `plugin-meta/plugin-health`, `tasks/tasks-core`
