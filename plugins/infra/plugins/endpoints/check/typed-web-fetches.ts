...
const ALLOWED = new Map<string, number>([
  ...
  ["plugins/conversations/plugins/conversation-view/plugins/code/plugins/review/web/components/review-sections-settings.tsx", 3],
  ["plugins/conversations/plugins/conversation-view/plugins/code/plugins/review/web/use-push-files.ts", 1],
