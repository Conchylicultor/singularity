...
ALTER TABLE "tasks" RENAME COLUMN "parent_id" TO "folder_id";--> statement-breakpoint
ALTER TABLE "tasks" DROP CONSTRAINT "tasks_parent_id_tasks_id_fk";
--> statement-breakpoint
DROP INDEX IF EXISTS "tasks_parent_rank_idx";--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "tasks" ADD CONSTRAINT "tasks_folder_id_tasks_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."tasks"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tasks_folder_rank_idx" ON "tasks" USING btree ("folder_id","rank");--> statement-breakpoint
CREATE VIEW "public"."tasks_v" AS (with "task_facts" as (select "id", EXISTS (
        ...
        ) as "has_blocking_dep" from "tasks") select "tasks"."id", "tasks"."folder_id", "tasks"."group_id", "tasks"."title", "tasks"."description", "tasks"."author", "tasks"."dropped_at", "tasks"."held_at", "tasks"."expanded", "tasks"."rank", "tasks"."created_at", "tasks"."updated_at", 
        CASE
