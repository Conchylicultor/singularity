 ...
 * rows; their `data.text` projections are field-scoped UPDATES, which never
 * create, so they can never resurrect a wiped row) and mounts the restored
 * ones. If this function ever
