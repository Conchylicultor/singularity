 ...
 *
 * The list used to be the app's one dead end: a 4-verb pipeline with two
 * artifacts and two revisions does not fit a row's rigid trailing region (already
 * three `RowActionButton`s and a run chip), so the row navigates here instead.
 *
