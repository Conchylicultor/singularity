...
// is on the thread. De-duplicated, capped to keep the row single-line.
//
// Re-implemented locally (a copy of thread-list's `senderSummary`) so this
// plugin never reaches into thread-list's `internal/`.
