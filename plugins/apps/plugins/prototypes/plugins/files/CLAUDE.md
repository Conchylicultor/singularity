...
- Server:
  ...
  - Routes: `GET /api/prototypes`, `GET /api/prototypes/:name`
- Core:
  - Uses: `infra/endpoints.defineEndpoint`, `primitives/live-state.resourceDescriptor`
  - Exports: Types: `PrototypeMeta`; Values: `listPrototypes`, `PrototypeMetaSchema`, `PROTOTYPES_API_BASE`, `prototypesResource`, `prototypesVersionResource`, `prototypeUrl`
