 ...
 *
 * Stated even though it equals the font-family group's schema defaults: the
 * site's design depends on it, and saying so here keeps it true if those
 * defaults ever move.
 */
