 ...
 * `muted` silences the track in the audio scheduler; `hidden` removes its notes
 * from the piano-roll. Both default to false so an absent row reads as the
 * natural "audible + visible" state.
 */
