...
export const handleListDefinitions = implement(
  listDefinitionsEndpoint,
  async () => {
    const rows = await db
      .select()
...
export const handleCreateDefinition = implement(
  createDefinitionEndpoint,
  async ({ body }) => {
...
export const handleGetDefinition = implement(
...
export const handleUpdateDefinition = implement(
  updateDefinitionEndpoint,
  async ({ params, body }) => {
...
export const handleDeleteDefinition = implement(
  deleteDefinitionEndpoint,
  async ({ params }) => {
...
export const handleListExecutions = implement(
  listExecutionsEndpoint,
  async ({ req }) => {
...
export const handleCreateExecution = implement(
...
export const handleGetExecution = implement(
...
export const handleDeleteExecution = implement(
  deleteExecutionEndpoint,
  async ({ params }) => {
...
export const handleSubmitStep = implement(
  submitStepEndpoint,
  async ({ params, body }) => {
    const [execution] = await db
      .select()
    ...
    if (step.status !== "suspended") {
      throw new HttpError(
        409,
        `Step status is "${step.status}", expected "suspended"`,
      );
    }
