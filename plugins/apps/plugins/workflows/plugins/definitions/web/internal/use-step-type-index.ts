 ...
 * row / trace can look up its icon, label, and (unsealed) `executionComponent`
 * by `step.pluginId` / `step.stepPluginId`. Collection-consumer clean: never
 * names a specific step-type contributor.
 */
